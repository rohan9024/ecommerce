...
const ShoeItem = (props) => {
    ...
    return (
        <motion.div
            className='sm:w-1/4 min-w-[300px] shadow-sm border border-gray-200 transition hover:scale-105 hover:ease-in-out hover:duration-500 hover:delay-125 hover:shadow-lg cursor-pointer'>
